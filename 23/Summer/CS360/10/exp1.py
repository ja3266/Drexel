...
import ply.yacc as yacc
	...
	# This is not needed in this example, since 'expr' is the first rule encountered
start = 'expr'

	# Given an ambiguous grammar, disambiguate explicitly:
	# tuples go from lowest precedence to highest
precedence = (
	( 'left', 'PLUS', 'MINUS' ),
	( 'left', 'TIMES', 'DIV' ),
	( 'nonassoc', 'UMINUS' )
...
# )
# yacc.yacc( debug=True, debuglog=logging.getLogger() )
